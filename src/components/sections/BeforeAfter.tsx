    ...
    <section className="relative py-16 lg:py-28">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-6 items-stretch">
          ...
          <div className="glass-card rounded-2xl p-5 sm:p-6 md:p-8 border-primary/30">
            <div className="mb-5 md:mb-6">
            ...
            <div className="rounded-xl border border-primary/20 bg-primary/5 p-3 mb-5 md:mb-6">
