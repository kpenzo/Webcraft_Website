      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
        <div className="text-center">
          ...
          <p className="text-lg md:text-xl text-text-secondary max-w-3xl mx-auto mb-8">
            Fast, professional websites designed for trades and service businesses
            that want more quote requests, stronger local trust, and better customer conversion.
          </p>
